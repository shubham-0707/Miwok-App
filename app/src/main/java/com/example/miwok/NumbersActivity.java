...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("eight" , "kavita" , R.drawable.number_eight));
        words.add(new Word("nine" , "woe", R.drawable.number_nine));
        words.add(new Word("ten","naaacha", R.drawable.number_ten));
